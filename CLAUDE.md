...
> **✅ الاسم الرسمي والدائم: OmniRad.** فيه محاولة إعادة تسمية لـ"TOMANEX" (19 يوليو 2026)
> **أُلغيت لاحقاً ولم تُطبَّق على المنصّة إطلاقاً** — راجع قسم "تراجع TOMANEX" أدناه للتفاصيل
> الكاملة. أي إشارة لـTOMANEX بهذا الملف هي سجل تاريخي فقط، لا قرار نشط.
...
- **حجم النافبار:** 56px
- **الشعار الفعلي المستخدم على GitHub:** شعار OmniRad الأصلي — لم يتغيّر، لا علاقة له بملفات `logo-tomanex-*` أدناه

> **📁 مرجع تاريخي فقط (غير مُستخدَم فعلياً):** أثناء محاولة TOMANEX المُلغاة، جُهِّزت ملفات
> شعار بديلة (`assets/logo-tomanex-master-dark.png` وتفريغاتها الشفافة، نُسخ SVG احتياطية،
> ومعاينة `TOMANEX Identity Preview.dc.html`) ودومين مرشَّح (`tomanex.sa`). **لا شيء من هذا
> مُطبَّق على المنصّة الحيّة** — أُبقيت الملفات فقط كمرجع استكشافي إذا احتُجنا إعادة النظر
> بالهوية البصرية مستقبلاً.
