...
(function () {
  ...
  css.textContent = [
    ...
    '.onav-un{font-size:12px;color:var(--text-s,rgba(232,240,245,.65));max-width:140px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:inline-block;vertical-align:middle}',
    '@media(max-width:720px){.onav-un{max-width:90px}}',
    '@media(max-width:520px){.onav-un{display:none}}',
