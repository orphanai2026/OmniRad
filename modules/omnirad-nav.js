...
(function () {
  ...
  css.textContent = [
    ...
    '.onav-un{font-size:12px;color:var(--text-s,rgba(232,240,245,.65));max-width:110px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:inline-block;vertical-align:middle;min-width:0}',
    '.onav-ua{max-width:180px;overflow:hidden}',
    '@media(max-width:900px){.onav-un{max-width:80px}}',
    '@media(max-width:720px){.onav-un{display:none}}',
